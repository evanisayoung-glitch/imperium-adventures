...
export const metadata: Metadata = {
  ...
  description:
    "Imperium Adventures makes websites that refuse to look ordinary — from $5,000 to $50,000.",
  openGraph: {
    title: "Imperium Adventures — Commissioned websites",
    description:
      "Websites that refuse to look ordinary. Living first pages. Five to fifty thousand.",
    type: "website",
  },
};
